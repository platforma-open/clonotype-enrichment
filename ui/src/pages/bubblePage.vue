...
const defaultOptions = computed((): GraphMakerProps['defaultOptions'] => {
  ...
  const defaults: PredefinedGraphOption<'bubble'>[] = [
    ...
    {
      inputName: 'x',
      selectedSource: bubblePcols[getIndex('pl7.app/vdj/temporarylabel', bubblePcols)].spec.axesSpec[1],
    },
    {
      inputName: 'y',
      selectedSource: bubblePcols[getIndex('pl7.app/vdj/temporarylabel', bubblePcols)].spec.axesSpec[0],
    },
    {
      inputName: 'valueColor',
      selectedSource: bubblePcols[getIndex('pl7.app/vdj/enrichment', bubblePcols)].spec,
    },
    {
      inputName: 'valueSize',
      selectedSource: bubblePcols[getIndex('pl7.app/vdj/frequency', bubblePcols)].spec,
    },
    {
      inputName: 'tooltipContent',
      selectedSource: bubblePcols[getIndex('pl7.app/vdj/temporarylabel', bubblePcols)].spec,
    },
